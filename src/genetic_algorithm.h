...
//structura folosita pentru a trimite argumentele in thread_function
...
void compute_fitness_function(const sack_object *objects, individual *generation, int object_count, int sack_capacity, int id, int num_threads);
